...
def has_request_arg(fn):
    ...
    for name, param in params.items():
        ...
        if found and (param.kind != inspect.Parameter.VAR_POSITIONAL and param.kind != inspect.Parameter.KEYWORD_ONLY and param.kind != inspect.Parameter.VAR_KEYWORD):
            raise ValueError('request patameter must be the last named parameter in function: %s%s' % (fn.__name__, str(sig)))
    return found
...
class RequestHandler(object):
    ...
    def __init__(self, app, fn):
        ...
        self._named_kw_arg = get_named_kw_arg(fn)
        ...
        if self._has_var_kw_arg or self._has_named_kw_arg or self._required_kw_arg:
            if request.method == 'POST':
                ...
                if ct.startswith('application/json'):
                    ...
                    return web.HTTPBadRequest('Unsupportted Content-Type: %s' (request.content_type))
